...
\frame{
	...
	\item[]
	\item Recall that $MC=\Delta VC/ \Delta q$, and note that with a fixed capital stock, the change in variable cost must be the change in the cost of labor. That is:
		\begin{align*}
