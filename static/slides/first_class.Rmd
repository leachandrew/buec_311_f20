...
- Macro uses aggregates (GDP, unemployment, & inflation) and studies both their behaviour over time and the drivers of aggregate trends 
- Micro is the study of constrained choices and consequences by individual economic agents
...
.center[
![:scale 70%](https://www.dropbox.com/s/bqb48eg20ld6li9/cooleconbooks.png?raw=1)
]
...
.pull-right[
.center[
![:scale 70%](https://www.dropbox.com/s/z5axki7ufozcgyn/imagination.png?raw=1)
]
]
