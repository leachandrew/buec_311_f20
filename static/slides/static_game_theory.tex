...
\frame{
	\frametitle{1. Strategic Interaction}
	\begin{itemize}
...
\frame{
	\frametitle{2. Prisoner's Dilemma Example}
	\begin{itemize}
...
\frame{
	\frametitle{3. Types of Nash Equilibria}
	\begin{itemize}
...
\frame{
	\frametitle{3. Example: Coordination Between Networks}
	\begin{figure}
...
\frame{
	\frametitle{4. Information and Rationality}
	\begin{itemize}
...
\frame{
	\frametitle{5. Using Game Theory to Make Business Decisions}
	\begin{itemize}
...
\frame{
	\frametitle{7. Auctions}
	\begin{itemize}
	\item Elements of auctions:
		\begin{itemize}
		\item Number of units:
			\begin{itemize}
			\item Auctions can be used to sell one or many units of a good.
			\end{itemize}
		\item[]
...
\frame{
	\frametitle{7. Second Price Sealed Bid Auctions}
	\begin{itemize}
	\item Rules:
		\begin{itemize}
