...
\frame{
	\frametitle{1. Two Additional Market Structures}
	\begin{itemize}
...
\frame{
	...
	\item The model we need to use to understand how oligopoly will work depends on whether firms are setting quantities or prices.
		\begin{itemize}
		\item If firms are independently setting quantities, we need to use the \underline{Cournot model}.
		\item If firms are independently setting prices, we need to use the \underline{Bertrand model}.
		\end{itemize}
	\end{itemize}
}

\frame{
	\frametitle{3. Cournot Oligopoly}
	\begin{itemize}
...
\frame{
	\frametitle{4. Bertrand Oligopoly}
	\begin{itemize}
	\item In the Bertrand model, prices are the strategic choice.
		\begin{itemize}
...
\frame{
	\frametitle{5. Monopolistic Competition}
	\begin{itemize}
