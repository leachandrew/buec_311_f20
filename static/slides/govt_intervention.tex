...
\frame{
	\frametitle{Outline}
	\begin{enumerate}
	\item \alert{Government Intervention}
	\item[]
	\item Market Failure and Government Policy
	\item[]
	\item Regulation of Imperfectly Competitive Markets
...
\frame{
	\frametitle{1. Government Intervention}
	\begin{itemize}
...
\frame{
	\frametitle{2. Market Failure and Government Policy}
	\begin{itemize}
...
\frame{
	\frametitle{3. Eliminating Market Failure Due to Imperfect Competition}
	\begin{itemize}
...
\frame{
	\frametitle{3. Regulation of Imperfectly Competitive Markets}
	\begin{itemize}
...
\frame{
	\frametitle{4. Antitrust Law and Competition Policy}
	\begin{itemize}
...
\frame{
	\frametitle{6. Open-Access, Club, And Public Goods}
	\begin{itemize}
...
\frame{
	\frametitle{7. Intellectual Property}
	\begin{itemize}
