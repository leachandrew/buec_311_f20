...
1. Suppose that my personal demand curve for coffee is given by $Q=4-\frac{2p}{3}$.
   ...
   a) Draw the inverse demand curve for this function (i.e P as a function of Q).
   
   b) How many cups of coffee would you expect me to consume per day at a price of      $2 per cup?
