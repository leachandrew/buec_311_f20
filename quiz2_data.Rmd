...
```
The quiz average over all three sections was `r round(mean(midterm_data$midterm,na.rm=T),2)`%.

The quiz averages for the individual sections were `r round(mean(midterm_A1$midterm,na.rm=T),2)`% for section A1, `r round(mean(midterm_A2$midterm,na.rm=T),2)`% for section A2 and `r round(mean(midterm_A3$midterm,na.rm=T),2)`% for section A3.
