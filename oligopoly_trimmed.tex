...
\frame{
	\frametitle{Monopolistic Competition}
	\begin{itemize}
	\item If all firms in a monopolistically competitive market \textbf{produce identical products and have identical costs}, each firm earns \textit{zero economic profit in the long run}.
	\item[]
	\item \textbf{If firms have different cost functions or produce differentiated products}, then firms will likely differ in their long run profitability.
		\begin{itemize}
...
\item[]
\item {I expect you to know the basics of cartel, Cournot and Bertrand oligopoly, as well as monopolistic competition, and to recognize what the graphs are telling you. You do not need to do any of the calculations.}
	\end{enumerate}
}
